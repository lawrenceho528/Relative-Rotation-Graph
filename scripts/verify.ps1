...
Assert-Check ($html.Contains('id="zoomInButton"') -and $html.Contains('id="zoomOutButton"') -and $html.Contains('id="zoomValue"')) "manual chart scale controls"
...
Assert-Check ($updater.Contains('class StooqProvider') -and $updater.Contains('https://stooq.com/q/d/l/') -and $updater.Contains('class TiingoProvider') -and $updater.Contains('TIINGO_API_KEY')) "Stooq-first updater with Tiingo secret-ready provider"
...
Assert-Check ($js.Contains('function setChartExtent') -and $js.Contains('function updateZoomOutput') -and $js.Contains('SCALE_LIMITS.step')) "zoom buttons adjust chart scale"
...
Assert-Check ($js.Contains('hiddenSymbols: new Set()') -and $js.Contains('function toggleSymbolVisibility') -and $js.Contains('visibility-toggle')) "show hide symbol controls"
Assert-Check ($js.Contains('sectors: [') -and $js.Contains('industries: [')) "sector and industry universes"
Assert-Check ($js.Contains('function assetSubtitle') -and $js.Contains('industry proxy') -and $js.Contains('GICS Sector')) "user-visible GICS sector and industry context"
